      ...
      <section className="py-20 bg-charcoal-950 border-t border-charcoal-800/40">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#collections" className="inline-flex items-center gap-2 bg-gold-gradient text-charcoal-950 font-semibold text-xs tracking-widest uppercase px-7 py-3.5 rounded hover:opacity-90 transition-opacity">
              Shop Collection
            </a>
