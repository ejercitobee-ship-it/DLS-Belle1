...
const products: Product[] = [
  {
    ...
    features: [
      '360° view — 4 glass sides',
      '3 removable & reversible cedar trays',
      '6 adjustable dividers',
      '2 large humidifiers included',
      'Calibrated external hygrometer',
      'Magnetic doors with airtight seal',
      'Lock & key set',
    ],
    description:
      'The Marciano commands attention. Four glass sides give a complete 360° view of your collection while deep mahogany woodwork and magnetic airtight doors keep conditions perfect for long-term aging.',
  ...
  },
  {
    ...
    features: [
      'Angled glass top display',
      '5 compartments with 4 cedar dividers',
      '2 gold-polished humidifiers',
      'Built-in external hygrometer',
      'Gold hardware — handles & lid pull',
      'Lock & key set',
      'Internal locking hinges',
    ],
    description:
      'The Modena blends countertop elegance with serious capacity. An angled glass lid offers an unobstructed view of up to 100 cigars, while gold-polished hardware elevates every detail.',
  ...
  },
  {
    ...
    features: [
      '6 open display sections',
      'External mount hygrometer',
      'Included humidifier',
      'Rear access door with lock & key',
      'Optional black or wood base',
      'Full 360° visibility',
    ],
    description:
      'Maximum visibility, minimal footprint. The Franklin\'s clear acrylic construction turns your collection into a statement piece — 150 cigars on full display with precision humidity control.',
  ...
  },
  {
    ...
    features: [
      '360° view — 4 tempered glass sides',
      '3 removable angled shelves',
      'Adjustable dividers',
      'Built-in external hygrometer',
      'Included humidifier',
      'Lock & key set',
    ...
    description:
      'Four tempered glass sides deliver a full 360° showcase for up to 125 cigars. The Milano\'s dark mahogany frame and angled cedar shelves make it as much a piece of furniture as a humidor.',
    image: 'https://dunnluxuryselections.com/cdn/shop/files/Marciano_250-cigar_countertop_display_humidor_with_Spanish_cedar_trays.jpg',
    rating: 4.6,
    reviews: 5,
  },
  {
    ...
    features: [
      'Decorative routed edge detail',
      'Adjustable cedar divider',
      'Built-in hygrometer',
      'Humidifier included',
    ...
    description:
      'The Duke brings refined walnut craftsmanship to everyday storage. Decorative routed edges and a full cedar interior make this an exceptional choice for personal collections of 25–50 cigars.',
  ...
  },
  {
    ...
    capacity: '25–50 cigars',
    capacityMax: 50,
    finish: 'Authentic ebony wood veneer',
    dimensions: '11" W × 8.5" D × 3.25" H',
    interior: 'Rich Spanish cedar',
    features: [
      'Authentic ebony veneer exterior',
      'Adjustable cedar divider',
      'Polished silver hygrometer',
      'Removable humidifier',
      'Internal locking hinges',
      'Low-profile wide design',
    ],
    description:
      'Genuine ebony veneer gives the Vizcaya a deep, dramatic grain that stands apart from standard wood-finished humidors. A polished silver hygrometer completes the striking contrast.',
  ...
  },
  {
    ...
    capacity: '25–50 cigars',
    capacityMax: 50,
    finish: 'Makore Pommele — natural striking grain',
    interior: 'Full Spanish cedar lining',
    features: [
      'Makore Pommele wood veneer',
      'Adjustable divider',
      'Polished silver hygrometer',
      'Included humidifier',
      'Internal locking hinges',
    ...
    description:
      'The rare Makore Pommele veneer produces a distinctive chatoyant grain pattern — no two boxes look the same. Full Spanish cedar interior ensures proper humidity retention.',
  ...
  },
  {
    ...
    capacity: '25–50 cigars',
    capacityMax: 50,
    finish: 'Rich cherry with glass top',
    dimensions: '10½" W × 8¾" D × 4¼" H',
    interior: 'Spanish cedar lining',
    features: [
      'Tempered glass top display',
      'External hygrometer',
      'Included humidifier',
      'Adjustable divider',
      'Scratch-resistant felt bottom',
    ...
    description:
      'Classic cherry finish meets modern glass-top design. The Chalet Glasstop lets you view your cigars at a glance while maintaining the ideal cedar environment inside.',
  ...
  },
  {
    ...
    capacity: '25–50 cigars',
    capacityMax: 50,
    finish: 'Deep black with glass top',
    dimensions: '10½" W × 8¾" D × 4¼" H',
    interior: 'Spanish cedar lining',
    features: [
    ...
    description:
      'A sleek, contemporary take on the classic glasstop humidor. The deep black exterior creates a dramatic contrast with the warm Spanish cedar interior.',
  ...
  },
  {
    ...
    capacityMax: 50,
    finish: 'Authentic dark walnut',
    dimensions: '10½" W × 8¾" D × 4¼" H',
    interior: 'Spanish cedar lining',
    features: [
      'Authentic dark walnut exterior',
      'Dedicated hygrometer',
      'Integrated humidifier',
      'Adjustable divider',
      'Scratch-resistant felt bottom',
      'Solid brass locking hinges',
    ],
    description:
      'Dark walnut exterior with solid brass locking hinges — the Chardonnay is a refined everyday humidor with premium construction details at an accessible price.',
  ...
  },
  {
    ...
    description:
      'The entry point to the Chalet family — honest cherry woodwork, full cedar interior, and everything you need to keep 25–50 cigars in perfect condition.',
  ...
  },
  {
    ...
    capacityMax: 20,
    finish: 'Black exterior with glass top',
    ...
    description:
      'Compact, elegant, and purpose-built for personal collections. The Chalet Black keeps up to 20 cigars at peak condition in a slim glass-top profile.',
...
function ProductDetail({ product, onBack }: { product: Product; onBack: () => void }) {
  ...
  const handleAdd = () => {
    addItem({ id: `dh-${product.id}`, name: product.name, subtitle: product.capacity, price: product.price, priceNum: product.priceNum, image: product.image, category: 'Desktop' });
    setAdded(true);
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              {[
                ...
                { icon: Layers, label: 'Interior', value: product.interior },
                { icon: Ruler, label: 'Dimensions', value: product.dimensions ?? 'See description' },
                { icon: Key, label: 'Finish', value: product.finish },
            ...
            {/* Features */}
            <div className="mb-8">
              <p className="text-cream-200/40 text-[10px] tracking-[0.3em] uppercase mb-3">Included Features</p>
  ...
  return (
    <div className="min-h-screen bg-charcoal-950 pb-24">
      ...
      <div className="relative h-56 md:h-72 overflow-hidden">
        <img
          src="https://dunnluxuryselections.com/cdn/shop/collections/ChatGPT_20Image_20Apr_2016_202026_2005_53_15_20PM_58d3c7d7-0abd-4484-9134-6aadfd64abfd.png"
          alt="Desktop Humidors"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
              ...
              {filterOpen && (
                <div className="absolute left-0 top-full mt-1 w-40 bg-charcoal-900 border border-gold-700/20 rounded shadow-xl z-10">
                  {capacityFilters.map((cf, i) => (
                    <button
                      key={cf.label}
                      onClick={() => { setCapacityFilter(i); setFilterOpen(false); }}
        ...
        {/* Product grid */}
        {sorted.length === 0 ? (
          <div className="py-24 text-center text-cream-200/30">
        ...
        <div className="mt-20 pt-12 border-t border-charcoal-800/40">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Electronic Humidors', 'Travel Humidors', 'Counter Displays', 'Accessories', 'Walk-In Humidors'].map((col) => (
              <a
                key={col}
                href={col === 'Electronic Humidors' ? '#electronic' : col === 'Walk-In Humidors' ? '#walk-in' : '#collections'}
