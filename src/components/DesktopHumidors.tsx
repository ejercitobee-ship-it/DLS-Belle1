...
import { ShoppingBag, Star, ChevronDown, ArrowLeft, Box, Ruler, Key, Layers, Filter, CheckCircle2, Loader2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="relative">
            <div className="rounded-lg overflow-hidden aspect-square">
              <img src={allImages[0]} alt={product.name} className="w-full h-full object-cover" loading="lazy" />
            </div>
            {product.badge && (
            ...
            {allImages.length > 1 && (
              <div className="flex gap-2 mt-3">
                {allImages.slice(1, 4).map((url, i) => (
                  <div key={i} className="w-16 h-16 rounded overflow-hidden border border-charcoal-700/60">
...
export default function DesktopHumidors() {
  ...
  const heroImage = collectionImage
    || 'https://dunnluxuryselections.com/cdn/shop/collections/ChatGPT_20Image_20Apr_2016_202026_2005_53_15_20PM_58d3c7d7-0abd-4484-9134-6aadfd64abfd.png';
