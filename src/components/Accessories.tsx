...
const products: Product[] = [
  {
    id: 1,
    name: 'Cigar Oasis Plus Electronic Humidifier',
    price: '$198',
    priceNum: 198,
    category: 'Humidification',
    tagline: 'Automatic precision humidity control',
    description:
      'The ultimate automatic humidity control system for medium to large humidors. Actively regulates moisture with a precision sensor, large backlit digital display, and optional Wi-Fi remote monitoring — removing all guesswork from cigar care.',
    material: 'Electronic system with digital display and water cartridge',
    features: [
      'Large backlit digital display — temp & humidity',
      'Adjustable set point, factory preset ~70% RH',
      'Quiet built-in fan for even air circulation',
      'Large water cartridge — months between refills',
      'Low-water indicator alerts',
      'Optional Wi-Fi app monitoring (subscription)',
      'Up to ~10 cubic feet capacity',
    ],
    includes: ['Device', 'Ribbon cable', 'Water cartridge'],
  ...
  {
    id: 2,
    name: 'Humidity Beads (1 lb)',
    price: '$20',
    priceNum: 20,
    category: 'Humidification',
    tagline: 'Reusable silica bead humidification',
    description:
      'Simple, reusable, low-maintenance humidification maintaining ideal 70% RH without messy gels or liquids contacting your cigars. Rechargeable with distilled water — works across desktop, cabinet, and travel humidors.',
    material: 'Clear silica gel crystals',
    features: [
      'Maintains 70% RH consistently',
      'Rechargeable and reusable — no replacement needed',
      'No gel contact with cigars',
      'Works in desktop, cabinet, and travel humidors',
      'Expands significantly when hydrated',
    ],
    includes: ['1 lb resealable bag of clear humidity gel crystals'],
    image: 'https://images.pexels.com/photos/3532551/pexels-photo-3532551.jpeg',
    rating: 4.7,
    reviews: 22,
  },
  {
    id: 3,
    name: '300 Series Digital Hygrometer (Gray)',
    price: '$25',
    priceNum: 25,
    category: 'Monitoring',
    tagline: 'Slim precision monitor with gunmetal finish',
    description:
      'Compact precision instrument designed specifically for cigar storage. The gunmetal bezel and slim 0.5" profile fits unobtrusively in any humidor, delivering real-time dual temperature and humidity readouts.',
    material: 'Digital with gunmetal bezel and gray finish',
    features: [
      'Real-time dual readout — temp & humidity',
      'Fahrenheit / Celsius toggle',
      'Built-in calibration for ongoing accuracy',
      'Double-sided Velcro mounting included',
      '0.5" slim profile',
      'Battery included',
    ],
    includes: ['1× Hygrometer (gray)', '1× Battery', '1× Double-sided Velcro mount'],
    dimensions: '1⅞" face diameter · 0.5" slim profile',
  ...
  {
    id: 4,
    name: 'Digital Hygrometer w/ Calibration (Gold)',
    price: '$23',
    priceNum: 23,
    category: 'Monitoring',
    tagline: 'Precision monitor with polished gold bezel',
    description:
      'Pairs exact humidity readings with a decorator-ready polished gold bezel — turning a functional device into a stylish room addition. Magnetic mounting included for instant placement on metal surfaces.',
    material: 'Digital with polished gold bezel',
    features: [
      'Large easy-to-read display',
      'Calibration feature for long-term accuracy',
      'Fahrenheit / Celsius toggle',
      'Magnetic mounting for metal surfaces',
      'Battery included for immediate setup',
    ],
    includes: ['1× Hygrometer (gold)', '1× Battery', '1× Magnetic mounting set'],
    dimensions: '2.49" face · 0.6" thickness',
    image: 'https://images.pexels.com/photos/1797428/pexels-photo-1797428.jpeg',
    rating: 4.7,
    reviews: 18,
  },
  {
    id: 5,
    name: 'Admiral\'s Voyage Ship Decanter Set',
    price: '$127',
    priceNum: 127,
    category: 'Barware',
    tagline: 'Hand-blown 1000ml ship decanter — 5 piece',
    description:
      'A hand-blown 1000ml carafe with a meticulously detailed glass ship floating inside — the perfect centerpiece for an executive office or cigar lounge. Presented in a secure gift-ready executive box.',
    material: 'Premium hand-blown lead-free crystalline glass',
    features: [
      'Internal glass ship detail — conversation piece',
      'Airtight glass stopper prevents oxidation',
      'Mahogany-stained display base',
      'Weighted for a premium feel',
      '4× globe-etched weighted rocks glasses',
      'Gift-ready executive box',
    ],
    includes: ['1× Ship decanter (1000ml)', '4× Globe-etched rocks glasses', 'Custom mahogany wood stand', 'Executive gift box'],
    dimensions: '1000ml (35oz)',
  ...
  {
    id: 6,
    name: 'Thin Red Line Whiskey Decanter Set',
    price: '$128',
    priceNum: 128,
    category: 'Barware',
    tagline: 'Firefighter tribute — tattered flag edition',
    description:
      'A tribute to first responders — the striking Tattered American Flag motif with iconic Red Line rendered in premium borosilicate glass. Presented in an engraved handcrafted wooden box.',
    material: 'Premium hand-blown borosilicate glass, lead-free & food-grade certified',
    features: [
      'High-definition tattered Red Line American Flag design',
      'Precision-engineered airtight glass stopper',
      'Extreme thermal shock resistance',
      'Weighted rocks glasses for comfortable grip',
      'Handcrafted engraved wooden presentation box',
    ],
    includes: ['1× Decanter (730ml / 24.7oz)', '2× 10oz rocks glasses', 'Engraved wooden presentation box'],
    dimensions: '730ml (24.7oz)',
    image: 'https://images.pexels.com/photos/1283219/pexels-photo-1283219.jpeg',
    badge: 'Limited',
    rating: 4.9,
    reviews: 6,
  ...
  {
    id: 7,
    name: 'Classic Square Whiskey Decanter Set',
    price: '$71',
    priceNum: 71,
    category: 'Barware',
    tagline: 'Gold rim — 3-piece executive set',
    description:
      'Timeless square silhouette with gold rim detailing and premium high-clarity glass. Dishwasher safe for easy maintenance and available with custom logo engraving for corporate gifting.',
    material: 'Premium high-clarity machine-made glass',
    features: [
      'Classic square silhouette with gold rim',
      'Dishwasher safe',
      'Substantial, premium feel in hand',
      'Customisable branding — logo engraving available',
    ],
    includes: ['1× Square decanter', '2× Matching whiskey glasses', 'Protective packaging'],
    dimensions: '113mm W × 306mm H · 1900g total',
    image: 'https://images.pexels.com/photos/1283219/pexels-photo-1283219.jpeg',
    rating: 4.6,
    reviews: 11,
  },
  {
    id: 8,
    name: 'Executive Dual-View Whiskey Smoker Kit',
    price: '$142',
    priceNum: 142,
    category: 'Barware',
    tagline: '12-piece infusion set with smoker gun',
    description:
      'Professional 12-piece infusion set for elevated mixology. The theatrical dual-view display lets you watch smoke dance around your spirits before the magnetic clasp seals it inside.',
    material: 'Premium wood, bamboo, and high-temp glass',
    features: [
      'Dual crystal-clear windows with magnetic clasp',
      'Advanced smoker gun with dual-speed fan',
      'Funnel-shaped reservoir for maximum smoke density',
      'Fits 2 glasses simultaneously',
      '6 wood chip varieties — Apple, Hickory, Oak, Cherry, Cinnamon, Mesquite',
      'Luxury bamboo presentation tray',
    ],
    includes: ['1× Smoker box', '1× Dual-speed smoker gun', '1× Bamboo tray', '1× Glass top', '6× Wood chip tins', '3× Screens', '1× Cleaning brush'],
  ...
  {
    id: 9,
    name: 'Rockford Grid Ashtray',
    price: '$35',
    priceNum: 35,
    category: 'Ashtrays',
    tagline: 'Cast aluminum grid on mango wood base',
    description:
      'High-polished cast aluminum grid atop a rich mango wood base — the Rockford Grid delivers striking contrast and substantial heft. The removable grid makes cleaning effortless.',
    material: 'Polished cast aluminum grid · mango wood base',
    features: [
      'High-polished cast aluminum removable grid',
      'Rich mango wood base',
      'Strategically placed holes guide ash to reservoir',
      'Felt-lined bottom protects surfaces',
      'Substantial weighted feel',
    ],
    includes: ['Ashtray with removable grid'],
  ...
  {
    id: 10,
    name: 'UrbanMatrX Ashtray',
    price: '$59',
    priceNum: 59,
    category: 'Ashtrays',
    tagline: 'Zinc alloy grid on golden walnut base',
    description:
      'A forward-looking statement piece combining a progressive grid-pattern polished zinc alloy top with an antiqued brass finish over a golden walnut wood base. Weather-resistant for indoor or outdoor use.',
    material: 'Gun gray zinc alloy top (antiqued brass) · golden walnut wood base',
    features: [
      'Progressive grid-pattern design',
      'Polished gun gray zinc alloy top',
      'Multiple slots for cigars and cigarettes',
      'Weather-resistant construction',
      'Felt-lined base protects surfaces',
    ],
    includes: ['Ashtray (ready to use)'],
    dimensions: '9" × 9" × 2" H',
    image: 'https://images.pexels.com/photos/5481916/pexels-photo-5481916.jpeg',
    badge: 'Popular',
    rating: 4.6,
...
function ProductDetail({ product, onBack }: { product: Product; onBack: () => void }) {
  ...
  const handleAdd = () => {
    addItem({ id: `acc-${product.id}`, name: product.name, subtitle: product.tagline, price: product.price, priceNum: product.priceNum, image: product.image, category: product.category });
    setAdded(true);
