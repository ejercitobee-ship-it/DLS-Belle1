...
export default function TravelHumidors() {
  ...
  const heroImage = collectionImage
    || '/images/collections/chat-gpt-image-apr-15-2026.png';
  ...
  return (
    <div className="min-h-screen bg-charcoal-950 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <BreadcrumbSchema
          items={[
            ...
            { label: 'Travel Humidors', href: '/collections/travel-humidors' }
          ]}
          className="mb-8 pt-4"
        />
      </div>
      ...
      <div className="relative min-h-[14rem] md:min-h-[18rem] overflow-hidden flex items-center">
        <img src={heroImage} alt="Travel Humidors" className="absolute inset-0 w-full h-full object-cover object-center" loading="lazy" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        ...
        {/* Product grid */}
        <h2 className="font-serif text-3xl text-white font-bold mb-8">Travel Humidor Options</h2>
        ...
        <section className="mt-20 pt-12 border-t border-charcoal-800/40">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {getRelatedLinks('/collections/travel-humidors').map(link => (
              <a
                key={link.href}
                href={link.href}
