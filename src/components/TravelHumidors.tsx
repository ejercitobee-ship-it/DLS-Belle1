...
const products: Product[] = [
  {
    ...
    price: '$452',
    priceNum: 452,
    capacity: '5–10 cigars',
    capacityMax: 10,
    finish: 'Rich brown leather — book-style',
    dimensions: 'Compact, shelf-ready',
    features: [
      'Book-style exterior for discreet storage',
      'Removable cigar tray',
      'Silver hygrometer included',
      'Humidifier included',
    ...
    description:
      'Literature-inspired elegance for the discerning traveler. The Novelist mimics a hardcover book — hide your collection in plain sight on a shelf, tuck it into luggage, or present it as a gift.',
    image: 'https://dunnluxuryselections.com/cdn/shop/files/Novelist_brown_leather_book_style_travel_cigar_humidor_with_cutter_and_hygrometer.jpg',
    badge: 'Premium',
    rating: 4.9,
    reviews: 8,
    includesTools: true,
  ...
  {
    id: 2,
    name: 'Manhattan Travel Humidor (Brown)',
    price: '$50',
    priceNum: 50,
    capacity: '4–8 cigars',
    capacityMax: 8,
    finish: 'Brown ostrich-motif leather',
    dimensions: '8⅛" L × 5½" W × 3⅛" H',
    features: [
      '180° flat opening — full access',
      'Removable cigar bed with Velcro strap',
      'Integrated perforated humidifier',
    ...
    description:
      'Brown ostrich-pattern leather engineered for enthusiasts who never compromise on freshness. The Manhattan opens flat at 180° for easy access, with a cutter and torch lighter built in.',
    image: 'https://dunnluxuryselections.com/cdn/shop/files/Manhattan_brown_leather_humidor_with_zipper_closure_for_cigars_up_to_7_inches.jpg',
    badge: 'Popular',
    rating: 4.8,
    reviews: 14,
    includesTools: true,
  ...
  {
    id: 3,
    name: 'Manhattan Travel Humidor (Black)',
    price: '$50',
    priceNum: 50,
    capacity: '4–8 cigars',
    capacityMax: 8,
    finish: 'Black ostrich-style bonded leather',
    dimensions: '8⅛" L × 5½" W × 3⅛" H',
    features: [
      '180° flat opening — full access',
      'Removable cigar bed with Velcro strap',
    ...
    description:
      'Sleek black ostrich-style bonded leather — refined style meets travel-ready practicality. Identical to the Brown Manhattan in every specification, with a darker, more contemporary aesthetic.',
    image: 'https://dunnluxuryselections.com/cdn/shop/files/Portable_Manhattan_travel_humidor_holding_4_8_cigars_up_to_7_inches.jpg',
    rating: 4.8,
    reviews: 11,
    includesTools: true,
  },
  {
    id: 4,
    name: '6 Cigar Leather Humidor',
    price: '$44',
    priceNum: 44,
    capacity: '6–15 cigars',
    capacityMax: 15,
    finish: 'PVC leather with white contrast stitching',
    dimensions: '7.25" W × 10.75" D × 1.5" H',
    features: [
      'Dual slide-out removable beds',
      'Spanish cedar lining',
      'Black humidifier included',
      'Up to 60 ring gauge capacity',
      'Lightweight yet sturdy',
      'Flexible storage configuration',
    ],
    description:
      'Elegant PVC leather with contrasting white stitching — a sophisticated slim case that holds 6 to 15 cigars depending on configuration. The dual slide-out beds accommodate wider ring gauges with ease.',
  ...
  {
    id: 5,
    name: 'Traveler 15 by Humidor Supreme',
    price: '$32',
    priceNum: 32,
    capacity: '9–12 cigars',
    capacityMax: 12,
    finish: 'Mahogany, Cherry, or Burl',
    dimensions: '9" W × 8" D × 2" H',
    features: [
      'Built-in humidification system',
      'XIKAR Boveda 60G RH seasoning packs',
      'Compact travel footprint',
      'Durable exterior — travel-resistant',
      'Available in 3 finishes',
    ],
    description:
      'A sleek travel-ready companion from Humidor Supreme. The Traveler 15 holds 9–12 cigars in a low-profile case built to resist the knocks of daily travel, included with Boveda seasoning packs.',
  ...
  {
    id: 6,
    name: 'Traveler 10 by Humidor Supreme',
    price: '$30',
    priceNum: 30,
    ...
    description:
      'Compact elegance meets dependable cigar care. The Traveler 10 bridges desktop and travel use — at home on a desk or tucked into a weekend bag.',
  ...
  {
    id: 7,
    name: 'Traveler 5 by Humidor Supreme',
    price: '$26',
    priceNum: 26,
    capacity: '8–12 cigars',
    capacityMax: 12,
    finish: 'Mahogany exterior',
    dimensions: '8¾" W × 5 11/16" D × 2" H',
    features: [
      'Clear acrylic window for instant inventory check',
      'Built-in humidification system',
      'Built-in hygrometer',
      'XIKAR Boveda 60G RH seasoning packs',
    ...
    description:
      'The ultimate compact travel companion — slim enough for carry-on use, with a transparent acrylic window so you can check your cigars without ever opening the lid.',
  ...
  {
    id: 8,
    name: 'Traveler 20 Slim by Humidor Supreme',
    price: '$25',
    priceNum: 25,
    originalPrice: '$79',
    capacity: '8–24 cigars',
    capacityMax: 24,
    finish: 'Durable slim exterior',
    dimensions: '9" W × 8½" D × 2¼" H',
    features: [
      'Built-in humidifier',
      'Spanish cedar interior',
    ...
    description:
      'The Traveler 20 Slim packs capacity for up to 24 cigars into a slim 2¼" profile — the best value in the range, currently on sale from $79.',
    image: 'https://dunnluxuryselections.com/cdn/shop/files/Humidor_Supreme_Traveller_20_Slim_travel_cigar_case_with_XIKAR_Boveda_60G_RH_packs.png',
    badge: 'Sale',
    rating: 4.6,
    reviews: 18,
  },
...
function ProductDetail({ product, onBack }: { product: Product; onBack: () => void }) {
  ...
  const handleAdd = () => {
    addItem({ id: `th-${product.id}`, name: product.name, subtitle: product.capacity, price: product.price, priceNum: product.priceNum, image: product.image, category: 'Travel' });
    setAdded(true);
            ...
            <div className="flex items-baseline gap-3 mb-2">
              ...
              {product.originalPrice && (
                <span className="text-red-400 text-sm font-semibold">
                  Save {Math.round((1 - product.priceNum / parseInt(product.originalPrice.replace('$', ''))) * 100)}%
                </span>
              )}
            </div>
  ...
  return (
    <div className="min-h-screen bg-charcoal-950 pb-24">
      ...
      <div className="relative h-56 md:h-72 overflow-hidden">
        <img
          src="https://dunnluxuryselections.com/cdn/shop/collections/Chat-GPT-Image-Apr-15-2026-03-58-42-PM_4b5fd768-7cd5-41d5-95bf-a8e2aa58523e.png"
          alt="Travel Humidors"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        ...
        <div className="mt-20 pt-12 border-t border-charcoal-800/40">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Desktop Humidors', 'Electronic Humidors', 'Counter Displays', 'Accessories', 'Walk-In Humidors'].map((col) => (
              <a
                key={col}
                href={
                  col === 'Electronic Humidors' ? '#electronic'
                  : col === 'Walk-In Humidors' ? '#walk-in'
                  : col === 'Desktop Humidors' ? '#desktop'
                  : '#collections'
                }
