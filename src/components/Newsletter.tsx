      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            ...
            <button
              type="submit"
              className="bg-gold-gradient text-charcoal-950 font-semibold text-xs tracking-widest uppercase px-6 py-3 rounded hover:opacity-90 active:scale-95 transition-all whitespace-nowrap"
            >
              Subscribe
            </button>
          </form>
