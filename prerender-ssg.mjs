...
const routes = [
  ...
  { path: '/financing', file: 'financing/index.html', title: "Financing | Dunn's Luxury Selections", description: "Finance your luxury humidor with Affirm — 0% interest, 4 monthly payments on qualifying purchases over $1,500.", canonical: 'https://dunnluxuryselections.com/financing' },
